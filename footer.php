              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="logo logo-footer">
                    <a href="index.html"><img src="img/footer-logo.png" class="footer-logo" alt="footer logo"></a>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <ul class="list-block list-block-inverted">
                    <li><a href="location.php">Site Map</a></li>
                ...
                <p class="developer">Design and develop by Philwebservices</p>
              </div><!-- /.row -->
